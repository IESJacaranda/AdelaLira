...
public class Provincia {
	...
	public boolean addCentro(String nombre, Centro centro) {
		boolean resul=false;
		Localidad c = new Localidad(nombre);
		if(this.listaLocalidades.contains(c)) {
			this.listaLocalidades.get(this.listaLocalidades.indexOf(c)).addCentro(centro);
			resul=true;
		}
		return resul;
	}
